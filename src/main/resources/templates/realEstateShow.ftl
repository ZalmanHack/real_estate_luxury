...
<#assign title><@spring.message code="real_estate.show.title"/> ${post.name!post.id}</#assign>
...
<#--                                <button type="button" data-bs-target="#realEstateCarousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>-->
                    ...
                    <div class="col d-flex flex-column px-3" id="title_info">
                        <div class="d-flex flex-column pb-4 px-0" style="flex: 1 1 auto">
                            <div class="" style="flex: 1 1 auto">
                                <div class="d-flex flex-row me-auto">
                                    ...
                                    <span class="badge rounded-pill bg-dark mb-2 me-3">${post.postStatus!''}</span>
                                </div>
                                <h3 class="card-title">${post.cityValue!''}</h3>
                        ...
                        <div class="row mt-4" style="width: auto; max-width: none">
                            <div class="col">
                                <a class="btn btn-success d-flex justify-content-center mt-3" href="https://api.whatsapp.com/send?phone=${post.author.phone?long?c}&text=&source=&data=" role="button" target="_blank" rel="noopener noreferrer">
                            ...
                            <#if post.latitude! != 0 && post.longitude! != 0>
                                <div class="col">
                                    <a class="btn btn-secondary d-flex justify-content-center mt-3" href="https://www.google.com/maps/search/${post.latitude?string("0.######")?replace(",", ".")},+${post.longitude?string("0.######")?replace(",", ".")}" role="button" target="_blank" rel="noopener noreferrer">
