                ...
                <div class="card-body text-dark h-100">
                    <div class="wrapper">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <p class="card-text fw-bold mb-0">${post.price}</p>
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a class="btn btn-outline-secondary d-flex justify-content-center mt-3" href="https://www.google.com/maps/search/${post.locationLatitude},+${post.locationLongitude}" role="button" target="_blank" rel="noopener noreferrer">
