...
alter table if exists post
    add constraint FK78bp9gho7d7pgf78v2sv8iqua foreign key (post_image_id) references post_image;
alter table if exists post
    add constraint FK2jsjuiymi0k21wv5k2dx9dtt9 foreign key (post_video_id) references post_video;
alter table if exists post_image
    add constraint FKsip7qv57jw2fw50g97t16nrjr foreign key (post_id) references post;
alter table if exists post_video
    add constraint FKgpvapujii6k9b2ab8n6o94d1y foreign key (post_id) references post;
