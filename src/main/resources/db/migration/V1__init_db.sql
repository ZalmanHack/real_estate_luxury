...
(
    ...
    gym              int2        not null,
    kitchen          int2        not null,
    latitude         float8      not null,
    living_room      int2        not null,
...
(
    id                 int8 generated by default as identity,
    change_date        DATE,
    change_post_status varchar(255),
    post_id            int8,
    primary key (id)
);
...
alter table if exists post_registry
    add constraint FKopmhm4hdi44yk1ywacgh9rx43 foreign key (post_id) references post;
